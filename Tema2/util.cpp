...
Mesh* CreateMesh_Tema2(std::unordered_map<std::string, Mesh*>& meshes, const char* name, const std::vector<VertexFormat>& vertices, const std::vector<unsigned int>& indices)
{
    unsigned int VAO = 0;
